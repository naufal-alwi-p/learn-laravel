...
@section('content')
    ...
    <div class="card mb-5 isi">
        @forelse ($posts as $post)
            <div class="card-body">
                ...
                <h6 class="card-subtitle text-body-secondary">Category: <a href="/category/{{ $post->category->slug }}" class="text-decoration-none">{{ $post->category->category }}</a></h6>
    ...
    <script src="/js/author_ajax.js"></script>
@endsection