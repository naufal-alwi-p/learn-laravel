...
function searchQuery() {
                ...
                for(let i = 0; i < size; i++) {
                    ...
                    content.innerHTML += `
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle text-body-secondary">Author: <a href="/author/${value.username}" class="text-decoration-none">${value.name}</a> | Category: <a href="/category/${value.category_slug}" class="text-decoration-none">${value.category}</a></h6>
    ...
    xhr.open("POST", protocolHostname + "/search-post");
